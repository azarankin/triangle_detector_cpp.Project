...
void pure_cuda_gaussian_blur_filter(const cv::Mat& src, cv::Mat& dst, cudaStream_t stream = 0);
...
void cuda_pure_gray_filter(const cv::Mat& src_bgr, cv::Mat& dst_gray, cudaStream_t stream = 0);
...
void pure_cuda_adaptive_threshold(const cv::Mat& src, cv::Mat& dst, cudaStream_t stream = 0);
...
void pure_cuda_threshold_filter(const cv::Mat& src, cv::Mat& dst, cudaStream_t stream = 0, unsigned char thresh = 128, unsigned char maxval = 255);
